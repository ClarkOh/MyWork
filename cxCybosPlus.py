...
class cxCpCodeMgr(cxCybosBase) :
    ...
    def GetStockMargetKind(self, code) :
        if self.com_cp != None :
            return self.com_cp.GetStockMargetKind(code)
...
class cxCpStockMst(cxCybosBaseWithEvent) :
    ...
    headerIndexDic = {
        ...
        32 : [u'long',     u'상장자본금'                           ] ,
        33 : [u'long',     u'외국인 DATA 일자'                     ] ,
        34 : [u'long',     u'외국인 TIME 일자'                     ] ,
        35 : [u'decimal',  u'외국인 상장 주식수'                   ] ,
        36 : [u'decimal',  u'외국인 주문 주식수'                   ] ,
        37 : [u'long',     u'외국인 한도 수량'                     ] ,
        38 : [u'float',    u'외국인 한도 비율'                     ] ,
        39 : [u'decimal',  u'외국인 주문가능수량'                  ] ,
        40 : [u'float',    u'외국인 주문가능비율'                  ] ,
        42 : [u'string',   u'증권 전산 업종 코드'                  ] ,
        43 : [u'short',    u'매매 수량 단위'                       ] ,
        44 : [u'char',     u'정상/이상급등/관리/거래 정지 코드'    ] ,
        45 : [u'char',     u'소속 구분 코드'                       ] ,
        46 : [u'long',     u'전일 거래량'                          ] ,
        47 : [u'long',     u'52주 최고가'                          ] ,
        48 : [u'long',     u'52주 최고일'                          ] ,
        49 : [u'long',     u'52주 최저가'                          ] ,
        50 : [u'long',     u'52주 최저일'                          ] ,
        52 : [u'string',   u'벤처기업 구분'                        ] ,
        53 : [u'string',   u'KOSPI200 채용 여부'                   ] ,
        54 : [u'short',    u'액면가'                               ] ,
        55 : [u'long',     u'예상 체결가'                          ] ,
        56 : [u'long',     u'예상 체결가 전일 대비'                ] ,
        57 : [u'long',     u'예상 체결 수량'                       ] ,
        58 : [u'char',     u'예상 체결가 구분 flag'                ] ,
        59 : [u'char',     u'장 구분 flag'                         ] ,
        60 : [u'char',     u'자사주 신청여부'                      ] ,
        61 : [u'long',     u'자사주 신청 수량'                     ] ,
        62 : [u'long',     u'거래원 외국계매도총합'                ] ,
        63 : [u'long',     u'거래원 외국계매수총합'                ] ,
        64 : [u'long',     u'신용잔고비율'                         ] ,
        65 : [u'char',     u'CB 여부'                              ] ,
        66 : [u'char',     u'관리구분'                             ] ,
        67 : [u'char',     u'투자경고구분'                         ] ,
        68 : [u'char',     u'거래정지구분'                         ] ,
        69 : [u'char',     u'불성실 공시구분'                      ] ,
        70 : [u'long',     u'BPS'                                  ] 
    }
